...
function createResult(){
    ...
    */
    if(ticketType.value === "animal" && quantity.value > 1){
        ...
        quantity.focus();
        discount = 1;
        alert("Jó, hogy nem egy egész állatkertet szeretnélm szállítani! :(")
    }
    //Amikor több állatot írnak be, akkor a quantity.value értéke  üres sztring lesz.
    //Mégis  működik a szorzás itt lenn!!! Mert "" --> 0 lesz! Inplicit konverzió!
